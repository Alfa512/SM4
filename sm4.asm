...
; Line 139
	...
	xor	esi, -1301273892			; b27022dcH
; Line 142
	and	DWORD PTR _i$[ebp], 0
	mov	DWORD PTR _rk0$[ebp], ecx
$LL19@sm4_setkey:
; Line 143
	push	0
	...
	push	eax
	call	_T
	xor	eax, DWORD PTR _rk0$[ebp]
	inc	DWORD PTR _i$[ebp]
	cmp	DWORD PTR _i$[ebp], 4
; Line 144
	mov	DWORD PTR _rk0$[ebp], edi
	pop	ecx
; Line 145
	mov	edi, ebx
; Line 146
	...
	pop	ecx
	mov	esi, eax
	jl	SHORT $LL19@sm4_setkey
; Line 148
	mov	esi, DWORD PTR _c$[ebp]
	mov	ecx, DWORD PTR _rk0$[ebp]
; Line 152
	push	4
